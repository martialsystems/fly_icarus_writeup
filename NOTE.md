...
Results. Locked metrics are Python engine output at the tree SHAs named in this note. They were not generated by a language model.

Text. This note was drafted with Grok (xAI). The depositor reviewed the text against the locked logs and takes responsibility for it. No AI tool is an author.

## Cite this note (2026-09-20)

This file is a note, not a finding and not a software deposit. Cite the frozen slice on the tree:

Martial Systems LLC. (2026). fly_icarus published-sign slice (science-2cf5fd6) [Computer software]. https://github.com/martialsystems/fly_icarus/tree/science-2cf5fd6

SWHID: swh:1:snp:f0619c4c7ef5bc90965f630063cd254ce48bba58
