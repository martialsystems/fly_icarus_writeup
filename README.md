...
The argument is [NOTE.md](NOTE.md). The PDF is [docs/fly_icarus_chain_note.pdf](docs/fly_icarus_chain_note.pdf). The SHA index is gist [12835f74](https://gist.github.com/martialsystems/12835f747d6360781f3cc7f91f243178). Do not restamp `@2cf5fd6`, `@45aa064`, `@e16856c`, `@de95257`, or `@01155c3`.
